...
else
{
	...
	$facebook_link = filter_var($_POST['facebook_link'], FILTER_SANITIZE_STRING);
	$twitter_link = filter_var($_POST['twitter_link'], FILTER_SANITIZE_STRING);
	$linkedIn_link = filter_var($_POST['linkedIn_link'], FILTER_SANITIZE_STRING);
    ...
    try
    {
        ...
        /*** prepare the insert ***/
        $stmt = $dbh->prepare("INSERT INTO candidate_details (first_name, last_name, candidate_student_number, candidate_password, candidate_email, facebook_link, twitter_link, linkedIn_link) VALUES (:first_name, :last_name, :candidate_student_number, :candidate_password, :candidate_email, :facebook_link, :twitter_link, linkedIn_link )");
        ...
        $stmt->bindParam(':facebook_link', $facebook_link, PDO::PARAM_STR);
        $stmt->bindParam(':twitter_link', $twitter_link, PDO::PARAM_STR);
        $stmt->bindParam(':linkedIn_link', $linkedIn_link, PDO::PARAM_STR);
