...
$query = mysql_query(
	'SELECT id, first_name, last_name, student_number, candidate_position, image_path, facebook_link, twitter_link, linkedIn_link FROM voting');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link href="css/Candidate_modal.css" rel="stylesheet" type="text/css">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="logout.php"><i class="fa fa-user"></i> Logout</a></li>
						...
						<div class="profile-text">
							...
							<div class="buttons">
								<a href="<?php echo $row['facebook_link']?>">
								<img src="images/facebook.png"/></a>
								<a href="<?php echo $row['twitter_link']?>">
								<img src="images/twitter.png"/></a>
								<a href="<?php echo $row['linkedIn_link']?>">
								<img src="images/linkedin.png"/></a>

							</div>
								<div class="buttons">
									<input type="submit" value="Email"  id="email" class="button green center">
									<a href="candidate.html"><input type="submit" value="Visit Profile"  id="submit" class="button blue center"></a>
